...
config :tradehub,
  ...
  public_trade_positions_sorted_size: "get_positions_sorted_by_size",
  public_trade_positions_sorted_risk: "get_positions_sorted_by_risk",
  public_trade_positions_sorted_pnl: "get_positions_sorted_by_pnl",
  public_trade_position: "get_position",
  public_trade_leverage: "get_leverage",
  public_trade_trades: "get_trades",
  public_trade_trades_by_account: "get_trades_by_account",
  public_trade_liquidations: "get_liquidations",
  ##
