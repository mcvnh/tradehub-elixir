defmodule Tradehub.Ticker do
  ...
  @spec candlesticks(String.t(), integer, integer, integer) :: {:ok, list(Tradehub.candlestick)} | {:error, HTTPoison.Error.t()}
  @doc """
  ...
  @spec market_stats() :: {:ok, list(Tradehub.market_stats)} | {:error, HTTPoison.Error.t()}
  @spec market_stats(String.t()) :: {:ok, list(Tradehub.market_stats)} | {:error, HTTPoison.Error.t()}
  @doc """
